...
function connectionsShowSchoolsPage() {
	...
	if ( ! current_user_can( 'connections_edit_categories' ) ) {
		...
		if ( $action === "edit_{$taxonomy}" ) {
			...
			<div class="wrap">
				<div class="form-wrap" style="width:600px; margin: 0 auto;">
					<h1><a name="new"></a><?php _e( 'Edit School', 'connections_degrees' ); ?></h1>
					...
					<p class="submit">
						...
						<input type="submit" name="update" id="update" class="button button-primary" value="<?php _e( 'Update School', 'connections_degrees' ); ?>"/>
					</p>
		...
		<?php
			...
			<div class="wrap nosubsub">
				...
				<h1>Connections : <?php _e( 'Schools', 'connections_degrees' ); ?></h1>

				<form class="search-form" action="" method="get">

					<input type="hidden" name="page" value="<?php echo esc_attr( $_REQUEST['page'] ); ?>"/>
					<?php $table->search_box( __( 'Search Schools', 'connections_degrees' ), $taxonomy ); ?>
				...
				<div id="col-container">
									...
									$(document).ready(function () {
										$('#doaction, #doaction2').click(function () {
											if ($('select[name^="action"]').val() == 'delete') {
												var m = 'You are about to delete the selected school(s).\n  \'Cancel\' to stop, \'OK\' to delete.';
					...
					<div id="col-left">
						<div class="col-wrap">
							...
							<div class="form-wrap">
								<h3><?php _e( 'Add New School', 'connections_degrees' ); ?></h3>
								...
								submit_button( __( 'Add New School', 'connections_degrees' ), 'primary', 'add' );
